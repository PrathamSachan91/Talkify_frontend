...
const AdminDashboard = () => {
  ...
  const {
    ...
    isLoading: lc,
    refetch: rc,
  } = useQuery({ queryKey: ["conversations"], queryFn: fetchConversation });
  ...
  const users = useMemo(
    () =>
      rawUsers
        ...
        .map((u) => ({
          ...u,
          status: bannedIds.has(u.auth_id) ? "banned" : "active",
        })),
    [rawUsers, hiddenUsers, bannedIds],
  );
                  ...
                  {sortedConvs.slice(0, 5).map((conv) => (
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${conv.unread_count > 0 ? "rgba(45,212,191,0.12)" : "var(--border-main)"}`,
                        cursor: "pointer",
                      }}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ display: "flex", gap: 5 }}>
                            <button
                              onClick={() => toggleBan(user.auth_id)}
                        ...
                        <button
                          onClick={() =>
                            confirmDelete(
                              ...
                              () => {
                                deleteGroup(group.conversation_id);
                                setConfirmModal(null);
                              },
                            )
                          }
          ...
          <div style={{ animation: "tabIn 0.2s ease-out" }}>
            ...
            >
              <div>
                ...
                >
                  ...
                  conversations with unread · {totalUnread} total unread
                </p>
              </div>
              <div
                style={{
            ...
            >
              {[
                ...
                {
                  label: "With Unread",
                  value: conversations.filter((c) => c.unread_count > 0).length,
                  sub: "need attention",
                  color: "#f87171",
              ...
              <div style={scrollWrap}>
                <div style={{ minWidth: 480 }}>
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "56px 1fr 80px 76px 58px 50px",
                      padding: "10px 18px",
                      borderBottom: "1px solid var(--border-main)",
                      fontSize: 10,
                      fontWeight: 700,
